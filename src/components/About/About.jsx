...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a120b] to-[#1a120b] via-[#3c2a21] text-amber-50 overflow-hidden relative">
      ...
      >
        <div className="max-w-4xl mx-auto">
          <motion.h1 className="text-5xl sm:text-6xl md:text-7xl font-bold font-serif bg-clip-text text-transparent bg-gradient-to-br  from-amber-500 to-yellow-600">
            Culinary Express
          </motion.h1>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            Crafting UnforgetTable dining experinces delivered to your doorstep.
          </motion.p>
        </div>
      </motion.section>
      <section className="py-12 gap-4 md:px-8 relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                <div className="absolute -inset-1 bg-gradient-to-br from-amber-600/30 to-amber-500/30 rounded-3xl blur-lg opacity-50 group-hover:opacity-80 transition-opacity duration-300" />
                <div className="relative bg-[#3c2a21]/90 backdrop-blur-2xl rounded-3xl overflow-hidden border border-amber-600/30 hover:border-amber-500 transition-all duration-300 h-full">
                  ...
                  <div className="p-8">
                    <motion.div
                      className="text-amber-500 inline-block mb-4"
                      whileHover={{ rotate: 15 }}
                    >
                      <Icon className="w-12 h-12 text-amber-500" />
                    </motion.div>
                    <h3 className="font-bold text-2xl mb-2 text-amber-100">
                      {f.title}
                    </h3>
      ...
      <section className="py-16 px-4 md:px-8 bg-gradient-to-br from-[#1a120b] to-[#3c2a21]/90">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 md:gap-12">
          {stats.map((s, i) => {
            const Icon = s.icon;
            ...
            return (
              ...
              >
                ...
                >
                  <div className="relative h-full bg-[#3c2a21] backdrop-blur-2xl rounded-lg border-2 border-amber-600/30 p-6 overflow-hidden transition-all duration-300">
                    <motion.div
                    ...
                    />
                    <div className="absolute inset-0 rounded-xl shadow-lg shadow-amber-900 " />
                    <div className="flex items-center justify-center relative z-10 h-full flex-col">
                      <motion.div
                ...
                <motion.div
                  className="absolute inset-x-4 bottom-0 h-8 bg-amber-900/30 blur-3xl rounded-full"
                  animate={{
      ...
      <section className="py-16 px-4 sm:px-8 relative">
        <div className="max-w-7xl mx-auto ">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            className="font-bold text-4xl sm:text-5xl md:text-6xl text-amber-100 text-center mb-12 font-serif"
          >
            ...
            {teamMembers.map((m, i) => {
              return (
                <motion.div
                  ...
                  className="relative group"
                >
                  <div className="relative h-full bg-[#3c2a21]/90 backdrop-blur-2xl rounded-3xl overflow-hidden border-2 border-amber-600/30 hover:border-amber-500 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-amber-500/20 ">
                    ...
                    <div className="p-8 text-center flex flex-col h-[calc(100% - 24rem)]">
                      <div className="mb-4">
                        ...
                        <p className="text-amber-100 text-lg font-cursive flex-grow">
                          {m.bio}
                        </p>
                        <motion.div
